...
$usersStmt->execute(['instructor']);
$instructors = $usersStmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Instructors - Melbourne LMS</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-chalkboard-teacher"></i> Instructors</h1>
                </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($instructors as $u): ?>
                                            <tr>
                                                ...
                                                <td class="text-end"><a class="btn btn-sm btn-outline-secondary" href="user_edit.php?id=<?php echo $u['id']; ?>"><i class="fas fa-edit"></i></a>
